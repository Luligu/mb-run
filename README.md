...
| `--upgrade [keywords...]`              | Upgrades the project's config and scaffolding files, then runs `npm install`. Optional keywords enable extras: `jest`, `vitest`, `bundle`, `obfuscate`.                                                                                                                                                                                                                                               |
