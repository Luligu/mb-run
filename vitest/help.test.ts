...
describe('help', () => {
  ...
  describe('printUsage', () => {
    ...
    it('documents the execution order of flags', () => {
      printUsage();
      const order = ['install', 'update', 'deep-clean', 'reset', 'clean', 'build', 'typecheck', 'test', 'format', 'lint', 'sort', 'watch'];
      let lastIndex = -1;
    ...
    it('documents --lint behavior with oxlint and eslint fallback', () => {
      printUsage();
    ...
    it('documents --format behavior with oxfmt and prettier fallback', () => {
      printUsage();
    ...
    it('documents --check behavior', () => {
      printUsage();
      expect(output).toContain('--check');
    });

    it('documents --fix behavior', () => {
      printUsage();
    ...
    it('documents --typecheck behavior', () => {
      printUsage();
    ...
    it('documents the --esbuild minify keyword', () => {
      printUsage();
